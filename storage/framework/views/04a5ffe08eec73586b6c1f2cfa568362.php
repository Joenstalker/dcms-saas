...
<div class="flex flex-col gap-6" x-data="{ 
        ...
        <div>
            <h1 class="text-3xl font-bold">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($tenant)): ?>
                    Create Role for <span class="text-primary"><?php echo e($tenant->name); ?></span>
                <?php else: ?>
                    Create System Role
    ...
    <form id="role-form" action="<?php echo e(route('admin.role-permission.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div class="card-body gap-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="e.g. Manager" class="input input-bordered focus:ring-2 focus:ring-primary/20 <?php $__errorArgs = ['name'];
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\admin\role-permission\create.blade.php ENDPATH**/ ?>