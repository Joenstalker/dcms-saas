    ...
    <div class="max-w-md w-full">
        <div class="bg-white rounded-3xl shadow-2xl border border-gray-100 p-8 relative z-10 transition-all duration-500 hover:shadow-sky-100">
            ...
            <div x-data="{ recovery: false }">
                <!-- Authentication Code -->
                <div x-show="! recovery">
                    <form method="POST" action="<?php echo e(route('two-factor.login')); ?>" class="space-y-4">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\auth\two-factor-challenge.blade.php ENDPATH**/ ?>