    ...
    <aside class="w-64 min-h-full bg-base-100 border-r border-base-300">
        ...
        <div class="p-4 border-b border-base-300">
            <div class="flex items-center gap-3">
                ...
                <?php elseif(isset($tenantCustomization['logo_path']) && $tenantCustomization['logo_path']): ?>
                    <img src="<?php echo e(asset('storage/' . $tenantCustomization['logo_path'])); ?>" alt="Logo" class="w-10 h-10 rounded">
                <?php else: ?>
        ...
        <ul class="menu p-4 w-full gap-1.5">
            ...
            <li>
                ...
                <?php elseif(auth()->user()->isDentist()): ?>
                ...
                <?php elseif(auth()->user()->isAssistant()): ?>
            ...
            <li>
                <details <?php echo e(request()->routeIs('tenant.patients.*') ? 'open' : ''); ?> name="sidebar-menu" class="group">
                    ...
                    <ul class="mt-1 ml-4 border-l-2 border-base-200 pl-2 gap-1">
                        ...
                        <?php if(auth()->user()->isOwner() || auth()->user()->isDentist()): ?>
                        <li>
