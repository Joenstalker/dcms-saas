                        ...
                        <tr class="border-b border-base-200 hover:bg-base-200/50 transition-colors duration-150">
                            ...
                            <td class="py-2 px-3">
                                <div class="flex items-center justify-end gap-1">
                                    <a href="<?php echo e(route('admin.users.show', $user)); ?>" class="btn btn-sm btn-ghost btn-circle h-8 w-8 min-h-0 hover:bg-base-200 tooltip tooltip-left" data-tip="View Profile">
