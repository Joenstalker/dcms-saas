<div class="navbar bg-base-100 border-b border-base-300 px-6 sticky top-0 z-30">
    ...
    <div class="flex-1">
        <h2 class="text-xl font-semibold"><?php echo $__env->yieldContent('page-title', 'Dentist Portal'); ?></h2>
    </div>
    
    <div class="flex-none gap-2">
        <div class="flex items-center gap-2 mr-4 text-xs font-medium text-base-content/50">
            <span class="badge badge-primary badge-outline badge-sm">Dentist</span>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/dentist/components/navbar.blade.php ENDPATH**/ ?>