...
<?php $__env->startSection('title', 'Patient Profile - ' . $patient->first_name . ' ' . $patient->last_name); ?>

<?php $__env->startSection('page-title', 'Patient Profile'); ?>
...
<div class="p-6 bg-base-200/50 min-h-screen">
    <div class="max-w-[1600px] mx-auto">
        ...
        <div class="flex justify-start mb-6">
            <a href="<?php echo e(route('tenant.patients.index', $tenant->slug)); ?>" class="btn btn-ghost btn-sm gap-2 opacity-60 hover:opacity-100 transition-opacity">
                    ...
                    <div class="card-body items-center text-center p-6">
                        <div class="avatar placeholder mb-4">
                            <div class="bg-primary/10 text-primary rounded-3xl w-32 h-32 border-4 border-base-100 shadow-lg">
                                <span class="text-4xl font-black"><?php echo e(substr($patient->first_name, 0, 1)); ?><?php echo e(substr($patient->last_name, 0, 1)); ?></span>
                            </div>
                        </div>
                        <h2 class="text-xl font-black text-base-content leading-tight"><?php echo e($patient->last_name); ?>, <?php echo e($patient->first_name); ?></h2>
                        <div class="text-[10px] uppercase font-bold opacity-40 tracking-widest mt-1">ID: <?php echo e(str_pad($patient->id, 8, '0', STR_PAD_LEFT)); ?></div>
                        
                        <div class="mt-4 space-y-1">
                            <div class="text-xs font-bold opacity-40">Last Visit: <?php echo e($patient->appointments->first() ? $patient->appointments->first()->scheduled_at->diffForHumans() : 'No visits'); ?></div>
                ...
                <div class="card bg-base-100 shadow-sm border border-base-200 overflow-hidden">
                    <div class="card-body p-0">
                        <div class="grid grid-cols-1 divide-y divide-base-100">
                            ...
                            ?>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $demographics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-4 flex flex-col hover:bg-base-200/30 transition-colors">
                                <span class="text-[10px] uppercase font-bold opacity-40 tracking-widest"><?php echo e($item['label']); ?></span>
                                <span class="text-sm font-bold text-base-content/80 mt-0.5"><?php echo e($item['value']); ?></span>
                            </div>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="p-6">
                            ...
                            <div id="tab-medical" class="tab-content-item">
                                <?php echo $__env->make('tenant.patients.medical_history', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>

                            <!-- Payment History Tab -->
                            <div id="tab-payments" class="tab-content-item hidden">
                                <?php echo $__env->make('tenant.patients.payment_history', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>

                            <!-- Photos & Gallery Tab -->
                            <div id="tab-photos" class="tab-content-item hidden">
                                <?php echo $__env->make('tenant.patients.galery_patients', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>

                            <!-- Dental Chart Tab -->
                            <div id="tab-chart" class="tab-content-item hidden">
                                <?php echo $__env->make('tenant.patients.dental_charts', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>

                            <!-- Appointments Tab -->
                            <div id="tab-appointments" class="tab-content-item hidden">
                                <?php echo $__env->make('tenant.patients.patient_appointment', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startPush('modals'); ?>
    ...
    <dialog id="update_balance_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box bg-base-100 rounded-3xl p-8 border border-base-200">
            ...
            <p class="text-sm opacity-60 mb-8 font-medium">Specify the current outstanding balance for <?php echo e($patient->first_name); ?>.</p>
            
            <form id="update_balance_form" method="POST" action="<?php echo e(route('tenant.patients.update-balance', [$tenant->slug, $patient->id])); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-control mb-8">
                    ...
                    <div class="relative group">
                        <input type="number" 
                               name="balance" 
                               step="0.01" 
                               value="<?php echo e($patient->balance); ?>" 
...
<?php echo $__env->make('layouts.tenant', ['tenant' => $tenant], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/patients/show.blade.php ENDPATH**/ ?>