<div id="tenant-navbar" data-turbo-permanent class="navbar bg-base-100 border-b border-base-300 px-6 sticky top-0 z-30">
    ...
    <div class="flex-none gap-2">
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 shadow-lg border border-base-300 p-2 mt-2">
                ...
                <li><a href="<?php echo e(route('tenant.settings.account', ['tenant' => $tenant->slug])); ?>">Account Settings</a></li>
                <li><hr class="my-2"></li>
                <li>
