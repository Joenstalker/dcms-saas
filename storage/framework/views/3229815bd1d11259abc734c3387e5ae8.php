    ...
    <div class="max-w-md mx-auto">
        ...
        <div class="space-y-4">
            ...
            <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition">
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        <a href="<?php echo e(route('admin.login')); ?>" class="btn btn-primary btn-sm">
                            Admin Login
                        </a>
                    </div>
                </div>
            ...
            <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition">
                <div class="card-body">
                    ...
                    <div class="card-actions justify-end">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-primary btn-sm">
                            Register / Login
                        </a>
                    </div>
                </div>
        ...
        <div class="text-center mt-8">
            <p class="text-sm text-base-content/70">
                ...
                <a href="<?php echo e(route('tenant.registration.index')); ?>" class="text-primary font-semibold hover:underline">
                    Register as clinic
                </a>
            </p>
        </div>
