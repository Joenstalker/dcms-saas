<div class="drawer-side">
    ...
    <aside class="w-64 min-h-full bg-base-100 border-r border-base-300">
        ...
        <ul class="menu p-4 w-full gap-1.5">
            ...
            <li>
                <a href="<?php echo e(route('tenant.patients.index', ['tenant' => $tenant->slug])); ?>" class="text-base-content/80 font-semibold flex items-center gap-3 hover:bg-base-200 rounded-lg p-2.5 transition-all">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(route('tenant.appointments.index', ['tenant' => $tenant->slug])); ?>" class="text-base-content/80 font-semibold flex items-center gap-3 hover:bg-base-200 rounded-lg p-2.5 transition-all">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="<?php echo e(route('tenant.settings.index', ['tenant' => $tenant->slug])); ?>" class="text-base-content/80 font-semibold flex items-center gap-3 hover:bg-base-200 rounded-lg p-2.5 transition-all">
                    <svg class="w-5 h-5 opacity-70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
