<?php $__env->startSection('page-title', 'Branding & Settings'); ?>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $presets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $preset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <label class="cursor-pointer group">
                                        <input type="radio" name="preset" value="<?php echo e($key); ?>" class="hidden"
                                            <?php echo e(($currentSettings?->theme_color_primary === $preset['primary']) ? 'checked' : ''); ?>

                                            onchange="applyPreset('<?php echo e($key); ?>')">
                                        <div class="p-3 rounded-xl border-2 border-base-300 hover:border-primary transition-all group-hover:shadow-lg">
                                            <div class="flex gap-1 mb-2">
                                                <div class="w-6 h-6 rounded-full" style="background-color: <?php echo e($preset['primary']); ?>"></div>
                                                <div class="w-6 h-6 rounded-full" style="background-color: <?php echo e($preset['secondary']); ?>"></div>
                                                <div class="w-6 h-6 rounded-full" style="background-color: <?php echo e($preset['accent']); ?>"></div>
                                            </div>
                                            <p class="text-xs font-medium text-center"><?php echo e($preset['name']); ?></p>
                                        </div>
                                    </label>
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div class="form-control">
                                ...
                                <div class="flex items-center gap-2">
                                    <input type="color" name="theme_color_primary" value="<?php echo e($currentSettings?->theme_color_primary ?? '#3b82f6'); ?>" class="w-10 h-10 rounded border border-base-300 cursor-pointer">
                                    <input type="text" name="theme_color_primary_hex" value="<?php echo e($currentSettings?->theme_color_primary ?? '#3b82f6'); ?>" class="input input-bordered w-24 font-mono text-sm" onchange="updateColorInput(this, 'theme_color_primary')">
                                </div>
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-medium">Secondary</span></label>
                                <div class="flex items-center gap-2">
                                    <input type="color" name="theme_color_secondary" value="<?php echo e($currentSettings?->theme_color_secondary ?? '#6366f1'); ?>" class="w-10 h-10 rounded border border-base-300 cursor-pointer">
                                    <input type="text" name="theme_color_secondary_hex" value="<?php echo e($currentSettings?->theme_color_secondary ?? '#6366f1'); ?>" class="input input-bordered w-24 font-mono text-sm">
                                </div>
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-medium">Accent</span></label>
                                <div class="flex items-center gap-2">
                                    <input type="color" name="theme_color_accent" value="<?php echo e($currentSettings?->theme_color_accent ?? '#0ea5e9'); ?>" class="w-10 h-10 rounded border border-base-300 cursor-pointer">
                                    <input type="text" name="theme_color_accent_hex" value="<?php echo e($currentSettings?->theme_color_accent ?? '#0ea5e9'); ?>" class="input input-bordered w-24 font-mono text-sm">
                                </div>
                            </div>
                            <div class="form-control">
                                <label class="label"><span class="label-text font-medium">Neutral</span></label>
                                <div class="flex items-center gap-2">
                                    <input type="color" name="theme_color_neutral" value="<?php echo e($currentSettings?->theme_color_neutral ?? '#6b7280'); ?>" class="w-10 h-10 rounded border border-base-300 cursor-pointer">
                                    <input type="text" name="theme_color_neutral_hex" value="<?php echo e($currentSettings?->theme_color_neutral ?? '#6b7280'); ?>" class="input input-bordered w-24 font-mono text-sm">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-control">
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" name="sidebar_position" value="left" class="hidden peer" <?php echo e(($currentSettings?->sidebar_position ?? 'left') === 'left' ? 'checked' : ''); ?>>
                                    ...
                                    <label class="cursor-pointer">
                                        <input type="radio" name="sidebar_position" value="right" class="hidden peer" <?php echo e(($currentSettings?->sidebar_position ?? 'left') === 'right' ? 'checked' : ''); ?>>
                                        <div class="p-4 rounded-xl border-2 border-base-300 peer-checked:border-primary peer-checked:bg-primary/5 transition-all text-center">
                                ...
                                <div class="form-control">
                                    ...
                                    <select name="font_family_heading" class="select select-bordered w-full">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableFonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($font); ?>" <?php echo e(($currentSettings?->font_family_heading ?? 'Figtree') === $font ? 'selected' : ''); ?> style="font-family: <?php echo e($font); ?>, sans-serif"><?php echo e($font); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                </div>
                                <div class="form-control">
                                    ...
                                    <select name="font_family_body" class="select select-bordered w-full">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $availableFonts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $font): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($font); ?>" <?php echo e(($currentSettings?->font_family_body ?? 'Inter') === $font ? 'selected' : ''); ?> style="font-family: <?php echo e($font); ?>, sans-serif"><?php echo e($font); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-control">
                                ...
                                <input type="text" name="custom_brand_name" value="<?php echo e($currentSettings?->custom_brand_name ?? ''); ?>" class="input input-bordered w-full" placeholder="e.g., Bright Smile Dental">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->getLogoUrl()): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e($currentSettings->getLogoUrl()); ?>" id="logo_preview" class="h-12 rounded border border-base-300" alt="Current Logo">
                                        <label class="cursor-pointer">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->getDarkLogoUrl()): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e($currentSettings->getDarkLogoUrl()); ?>" id="dark_logo_preview" class="h-12 rounded border border-base-300" alt="Current Dark Logo">
                                        <label class="cursor-pointer">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->getFaviconUrl()): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e($currentSettings->getFaviconUrl()); ?>" id="favicon_preview" class="h-8 w-8 rounded" alt="Current Favicon">
                                        <label class="cursor-pointer">
                    ...
                    <div class="card-body">
                        ...
                        <div id="branding-preview" class="rounded-xl overflow-hidden border border-base-300 bg-base-200">
                            <div class="p-4 bg-primary text-primary-content">
                                <p class="font-bold text-lg" id="preview-brand"><?php echo e($currentSettings?->custom_brand_name ?? $tenant->name); ?></p>
                            </div>
...
<script>
    const presets = <?php echo json_encode($presets, 15, 512) ?>;
    const colorInputs = {
    ...
    document.querySelectorAll('input[name="custom_brand_name"]').forEach(input => {
        input.addEventListener('input', (e) => {
            previewBrand.textContent = e.target.value || '<?php echo e($tenant->name); ?>';
        });
    });
...
<?php echo $__env->make('layouts.tenant', ['tenant' => $tenant], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/settings/branding.blade.php ENDPATH**/ ?>