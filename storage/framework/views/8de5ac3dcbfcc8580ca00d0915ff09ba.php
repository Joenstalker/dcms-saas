                    ...
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->logo_path): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e(asset('storage/' . $currentSettings->logo_path)); ?>" class="h-12 rounded border border-base-300" alt="Current Logo">
                                        <label class="cursor-pointer">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->dark_logo_path): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e(asset('storage/' . $currentSettings->dark_logo_path)); ?>" class="h-12 rounded border border-base-300" alt="Current Dark Logo">
                                        <label class="cursor-pointer">
                            ...
                            <div class="form-control">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentSettings?->favicon_path): ?>
                                    <div class="mt-2 flex items-center gap-3">
                                        <img src="<?php echo e(asset('storage/' . $currentSettings->favicon_path)); ?>" class="h-8 w-8 rounded" alt="Current Favicon">
                                        <label class="cursor-pointer">
