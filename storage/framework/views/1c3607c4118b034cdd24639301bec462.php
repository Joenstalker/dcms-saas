...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $gallery_images ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="group relative aspect-square rounded-2xl overflow-hidden border border-base-200 bg-base-300">
        <img src="<?php echo e($image->url); ?>" alt="Procedure Documentation" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
        ...
        <div class="absolute bottom-2 left-2 right-2 p-2 bg-black/60 backdrop-blur-md rounded-lg text-[10px] text-white opacity-0 group-hover:opacity-100 transition-opacity truncate">
            <?php echo e($image->description ?? 'Procedure documentation'); ?>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/patients/galery_patients.blade.php ENDPATH**/ ?>