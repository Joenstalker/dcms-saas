<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($is_modal) && $is_modal): ?>
    <div class="space-y-6">
...
<?php else: ?>
    ...
    <div class="p-6 max-w-3xl mx-auto">
        <!-- ... existing content for standalone page ... -->
        <div class="mb-6">
