        ...
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body text-center p-8 sm:p-12">
                ...
                <p class="text-lg text-base-content/70 mb-6">
                    Thank you for registering <strong><?php echo e($tenant->name); ?></strong>
                </p>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-base-content/70">
                                    We've sent a verification email to <strong><?php echo e($tenant->email); ?></strong>
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start gap-3">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-mono text-primary mt-1"><?php echo e($tenant->slug); ?>.<?php echo e(env('LOCAL_BASE_DOMAIN', 'lvh.me')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\registration\success.blade.php ENDPATH**/ ?>