<div class="space-y-8">
    ...
    <div class="bg-gradient-to-r from-secondary to-secondary-focus rounded-xl p-8 text-white shadow-lg relative overflow-hidden">
        <div class="relative z-10">
            <h1 class="text-3xl font-bold mb-2">Hello, <?php echo e(auth()->user()->name); ?>!</h1>
            ...
            <div class="card-body p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1"><?php echo e($stats['pending_appointments']); ?></h3>
                    </div>
            ...
            <div class="card-body p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1"><?php echo e($stats['today_appointments']); ?></h3>
                    </div>
            ...
            <div class="card-body p-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h3 class="text-3xl font-bold mt-1"><?php echo e($stats['total_patients']); ?></h3>
                    </div>
                ...
                <div class="mt-4 flex items-center text-xs text-accent">
                    <a href="<?php echo e(route('tenant.patients.index', $tenant)); ?>" class="hover:underline">Manage Patient Records</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card bg-base-100 shadow-xl overflow-hidden">
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra w-full">
                        ...
                        <tbody>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $upcomingAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                            <tr>
                                <td>
                                    <div class="flex flex-col">
                                        <span class="font-bold"><?php echo e($appointment->patient->first_name); ?> <?php echo e($appointment->patient->last_name); ?></span>
                                        <span class="text-xs text-base-content/60"><?php echo e($appointment->patient->phone); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge badge-ghost">Dr. <?php echo e($appointment->dentist->name); ?></span>
                                </td>
                                <td>
                                    <div class="flex flex-col text-sm">
                                        <span class="font-medium"><?php echo e($appointment->scheduled_at->format('M d, Y')); ?></span>
                                        <span class="text-base-content/60"><?php echo e($appointment->scheduled_at->format('h:i A')); ?></span>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge badge-sm <?php echo e($appointment->status === 'confirmed' ? 'badge-success' : ($appointment->status === 'pending' ? 'badge-warning' : 'badge-ghost')); ?>">
        ...
        <div class="space-y-6">
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <div class="space-y-2">
                        <a href="<?php echo e(route('tenant.patients.index', $tenant)); ?>" class="btn btn-primary btn-block justify-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                            </svg>
                            Register New Patient
                        </a>
                        <a href="<?php echo e(route('tenant.patients.index', $tenant)); ?>" class="btn btn-ghost btn-block justify-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="card bg-base-100 shadow-xl">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-1 gap-3">
                        <a href="<?php echo e(route('tenant.services.index', $tenant)); ?>" class="btn btn-outline btn-block justify-start gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/assistant/tabs/home.blade.php ENDPATH**/ ?>