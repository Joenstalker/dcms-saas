<div class="fixed inset-y-0 left-0 z-50 w-64 bg-base-100 shadow-xl border-r border-base-300 lg:block hidden">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.role-permission.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('admin.role-permission.*') ? 'bg-primary text-primary-content shadow-lg' : 'hover:bg-base-200'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
