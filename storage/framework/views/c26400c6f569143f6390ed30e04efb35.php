<div id="admin-sidebar" data-turbo-permanent class="fixed inset-y-0 left-0 z-50 w-64 bg-base-100 shadow-xl border-r border-base-300 lg:block hidden">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="<?php echo e(route('admin.themes.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('admin.themes.*') ? 'bg-primary text-primary-content shadow-lg' : 'hover:bg-base-200'); ?>">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Platform Section -->
            <div class="pt-2">
                <div class="px-4 py-2 text-xs font-semibold text-base-content/50 uppercase tracking-wider">
                    Platform
                </div>
                <a href="<?php echo e(route('admin.platform-updates.index')); ?>" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all <?php echo e(request()->routeIs('admin.platform-updates.*') ? 'bg-primary text-primary-content shadow-lg' : 'hover:bg-base-200'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                    </svg>
                    <span class="font-medium">Platform Updates</span>
                </a>
            </div>
