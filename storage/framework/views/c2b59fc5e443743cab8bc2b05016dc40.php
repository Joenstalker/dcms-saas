        ...
        <div id="dental-chart" class="p-4 bg-white rounded-2xl border border-base-200 shadow-inner">
            <table class="mx-auto border-separate border-spacing-x-1 border-spacing-y-2">
                <tbody>
                    ...
                    <!-- Upper Arch SVGs -->
                    <tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['molar', 'molar', 'molar', 'premolar-5', 'premolar-4', 'incisor', 'incisor', 'incisor']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <svg width="24" height="40" transform="scale(1,-1)" class="<?php echo e($type); ?> cursor-pointer transition-all duration-200 hover:opacity-80">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'molar'): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['incisor', 'incisor', 'incisor', 'premolar-4', 'premolar-5', 'molar', 'molar', 'molar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <svg width="24" height="40" transform="scale(1,-1)" class="<?php echo e($type); ?> cursor-pointer transition-all duration-200 hover:opacity-80">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'incisor'): ?>
                                    <polygon id="top" points="8,0 16,0 16,12 8,12" class="polygon unmarked" />
                                    <polygon id="left" points="0,8 8,8 8,16 0,16" class="polygon unmarked" />
                                    <polygon id="bottom" points="8,12 16,12 16,24 8,24" class="polygon unmarked" />
                                    <polygon id="right" points="16,8 24,8 24,16 16,16" class="polygon unmarked" />
                    ...
                    <!-- Lower Arch SVGs -->
                    <tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['molar', 'molar', 'molar', 'premolar-5', 'premolar-5', 'incisor', 'incisor', 'incisor']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <svg width="24" height="40" class="<?php echo e($type); ?> cursor-pointer transition-all duration-200 hover:opacity-80">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'molar'): ?>
                                    <polygon id="top" points="0,0 24,0 16,8 8,8" class="polygon unmarked" />
                                    <polygon id="left" points="0,0 8,8 8,16 0,24" class="polygon unmarked" />
                                    <polygon id="bottom" points="0,24 8,16 16,16 24,24" class="polygon unmarked" />
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = ['incisor', 'incisor', 'incisor', 'premolar-5', 'premolar-5', 'molar', 'molar', 'molar']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td>
                            <svg width="24" height="40" class="<?php echo e($type); ?> cursor-pointer transition-all duration-200 hover:opacity-80">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'incisor'): ?>
                                    <polygon id="top" points="8,0 16,0 16,12 8,12" class="polygon unmarked" />
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/patients/dental_charts.blade.php ENDPATH**/ ?>