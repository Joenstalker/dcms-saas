<div class="space-y-6 p-2">
    ...
    <div class="flex items-start gap-6">
        ...
        <div class="flex-1">
            <h2 class="text-2xl font-bold text-base-content"><?php echo e($user->name); ?></h2>
            <div class="flex items-center gap-2 mt-1">
                <span class="badge badge-primary badge-outline capitalize"><?php echo e($user->role ?? 'Staff'); ?></span>
                <span class="badge <?php echo e($user->status === 'active' ? 'badge-success' : 'badge-ghost'); ?> badge-sm capitalize"><?php echo e($user->status); ?></span>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-1">
            ...
            <p class="font-medium capitalize"><?php echo e($user->role_name); ?></p>
        </div>
        
        <div class="space-y-1">
            <p class="text-[10px] uppercase font-bold tracking-widest opacity-40">Account Status</p>
            <p class="font-medium flex items-center gap-2">
                <span class="w-2 h-2 rounded-full <?php echo e($user->status === 'active' ? 'bg-success' : 'bg-base-300'); ?>"></span>
            ...
            <p class="font-medium">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->email_verified_at): ?>
                    <span class="text-success flex items-center gap-1">
                        ...
                        <?php echo e($user->email_verified_at->format('M d, Y')); ?>
        ...
        <div class="space-y-1">
            ...
            <p class="font-medium text-base-content/70"><?php echo e($user->created_at->format('M d, Y')); ?></p>
        </div>
    </div>

    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($user->must_reset_password): ?>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/users/show.blade.php ENDPATH**/ ?>