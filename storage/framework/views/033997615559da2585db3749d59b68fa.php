<div class="navbar bg-base-100 border-b border-base-300 px-6 sticky top-0 z-30">
    ...
    <div class="flex-1">
        <h2 class="text-xl font-semibold"><?php echo $__env->yieldContent('page-title', 'Assistant Portal'); ?></h2>
    </div>
    
    <div class="flex-none gap-2">
        <div class="flex items-center gap-2 mr-4 text-xs font-medium text-base-content/50">
            <span class="badge badge-secondary badge-outline badge-sm">Assistant</span>
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box z-[1] w-52 shadow-lg border border-base-300 p-2 mt-2">
                ...
                <li><a href="<?php echo e(route('tenant.settings.index', ['tenant' => $tenant->slug])); ?>">Profile Photo</a></li>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/assistant/components/navbar.blade.php ENDPATH**/ ?>