...
<head>
    ...
    <title>Subscription Expired - <?php echo e(config('app.name')); ?></title>
            ...
            <div class="card-body p-8 md:p-12">
                ...
                <div class="text-center mb-8">
                    <p class="text-lg text-base-content/80 mb-4">
                        Your subscription for <strong><?php echo e($tenant->name); ?></strong> has expired.
                    </p>
                ...
                <div class="stats stats-vertical lg:stats-horizontal shadow mb-8 w-full">
                    <div class="stat">
                        ...
                        <div class="stat-value text-2xl"><?php echo e($tenant->subscription_ends_at->format('M d, Y')); ?></div>
                        <div class="stat-desc"><?php echo e($tenant->subscription_ends_at->diffForHumans()); ?></div>
                    </div>
                    ...
                    <div class="stat">
                        ...
                        <div class="stat-value text-2xl"><?php echo e($tenant->pricingPlan->name); ?></div>
                        <div class="stat-desc">₱<?php echo e(number_format($tenant->pricingPlan->price, 2)); ?>/<?php echo e($tenant->pricingPlan->billing_cycle); ?></div>
                    </div>
                ...
                <div class="card bg-base-200 mb-8">
                    <div class="card-body">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- Email -->
                            <a href="mailto:<?php echo e(config('mail.from.address')); ?>" class="flex items-center gap-3 p-4 bg-base-100 rounded-lg hover:bg-base-300 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="font-semibold truncate"><?php echo e(config('mail.from.address')); ?></p>
                                </div>
                            </a>

                            <!-- Phone -->
                            <a href="tel:<?php echo e(config('app.support_phone', '+63 123 456 7890')); ?>" class="flex items-center gap-3 p-4 bg-base-100 rounded-lg hover:bg-base-300 transition-colors">
                                <div class="flex-shrink-0">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="font-semibold truncate"><?php echo e(config('app.support_phone', '+63 975 686 4187')); ?></p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo e(route('tenant.subscription.select-plan', ['tenant' => $tenant->slug])); ?>" class="btn btn-primary btn-lg gap-2">
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/subscription/suspended.blade.php ENDPATH**/ ?>