        ...
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body p-8 md:p-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <a href="tel:<?php echo e(config('app.support_phone', '+63 123 456 7890')); ?>" class="flex items-center gap-3 p-4 bg-base-100 rounded-lg hover:bg-base-300 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="font-semibold truncate"><?php echo e(config('app.support_phone', '+63 123 456 7890')); ?></p>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="text-center">
                    ...
                    <a href="<?php echo e(route('tenant.subscription.select-plan', ['tenant' => $tenant->id])); ?>" class="btn btn-primary btn-lg gap-2">
