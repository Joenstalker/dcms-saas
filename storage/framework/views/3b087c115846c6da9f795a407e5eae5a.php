...
<div x-show="activeTab === 'patients'" class="space-y-6">
    <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
            ...
            <button class="btn btn-primary btn-sm" onclick="window.location.href='<?php echo e(route('tenant.patients.index', $tenant)); ?>'">+ New Patient Record</button>
        </div>
    </div>
                ...
                <div class="card-body p-0">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table table-zebra w-full">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $recent_patients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $patient): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="font-bold text-sm"><?php echo e($patient->first_name); ?> <?php echo e($patient->last_name); ?></div>
                                        </div>
                                    </td>
                                    <td class="text-xs"><?php echo e($patient->phone); ?></td>
                                    <td class="text-xs"><?php echo e($patient->updated_at->format('M d, Y')); ?></td>
                                    <td class="text-right">
                                        <div class="join">
                    ...
                    <div class="p-4 border-t border-base-200 text-center">
                        <a href="<?php echo e(route('tenant.patients.index', $tenant)); ?>" class="text-primary text-sm font-bold hover:underline">View Full Patient Directory</a>
                    </div>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/dentist/tabs/patients.blade.php ENDPATH**/ ?>