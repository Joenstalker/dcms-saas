        ...
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body p-6 sm:p-8">
                ...
                <form id="registration-form" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="pricing_plan_id" value="<?php echo e(request('plan', \App\Models\PricingPlan::where('is_active', true)->orderBy('sort_order')->first()?->id)); ?>">
                    ...
                    <div>
                        ...
                        <div class="form-control mb-4">
                            ...
                            <div class="join w-full">
                                <input type="text" name="desired_subdomain" id="subdomain" value="<?php echo e(old('desired_subdomain')); ?>" 
                                    class="input input-bordered join-item flex-1" 
                                    placeholder="smiledental" required>
                                <span class="join-item bg-base-200 px-4 flex items-center border border-base-300">.<?php echo e(env('LOCAL_BASE_DOMAIN', 'lvh.me')); ?></span>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" name="state_province" value="<?php echo e(old('state_province')); ?>" 
                                    class="input input-bordered" 
                        ...
                        <div class="form-control mb-6">
                            ...
                            <input type="tel" name="phone_number" value="<?php echo e(old('phone_number')); ?>" 
                                class="input input-bordered" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\registration\modal-flow.blade.php ENDPATH**/ ?>