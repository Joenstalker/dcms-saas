<div class="flex items-center justify-between mb-6">
    ...
    <div class="text-right">
        ...
        <div class="text-xl font-black text-error" id="profile-balance-display">Php <?php echo e(number_format($patient->balance ?? 0, 2)); ?></div>
    </div>
</div>
    ...
    <table class="table table-md w-full">
        ...
        <tbody>
            ...
            <tr class="hover:bg-base-200/30 transition-colors">
                <td class="text-sm opacity-70 pl-4"><?php echo e($payment->date->format('M d, Y')); ?></td>
                <td class="text-sm font-medium"><?php echo e($payment->description); ?></td>
                <td class="text-sm font-bold">Php <?php echo e(number_format($payment->amount, 2)); ?></td>
                <td class="text-sm text-success font-bold">Php <?php echo e(number_format($payment->paid, 2)); ?></td>
                <td>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isAssistant() || auth()->user()->isOwner()): ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/patients/payment_history.blade.php ENDPATH**/ ?>