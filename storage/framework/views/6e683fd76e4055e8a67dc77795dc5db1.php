                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <div class="join">
                                ...
                                <form action="<?php echo e(route('tenant.patients.destroy', [$tenant->slug, $patient->id])); ?>" method="POST" data-confirm-delete="Are you sure you want to delete this patient? This action cannot be undone." class="inline">
                                    <?php echo csrf_field(); ?>
