...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="stat bg-base-100 border border-base-300 rounded-xl">
            ...
            <div class="stat-value text-primary"><?php echo e($patients->total()); ?></div>
            ...
            <table class="table table-zebra w-full">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="avatar placeholder">
                                    <div class="bg-neutral-focus text-neutral-content rounded-full w-10">
                                        <span><?php echo e(substr($patient->first_name, 0, 1)); ?><?php echo e(substr($patient->last_name, 0, 1)); ?></span>
                                    </div>
                                </div>
                                <div>
                                    <div class="font-bold"><?php echo e($patient->first_name); ?> <?php echo e($patient->last_name); ?></div>
                                    <div class="text-xs opacity-50">#PAT-<?php echo e(str_pad($patient->id, 5, '0', STR_PAD_LEFT)); ?></div>
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <div class="text-sm">
                                <?php echo e($patient->dob ? $patient->dob->age . ' years' : 'N/A'); ?>

                                <div class="badge badge-ghost badge-sm mt-1 uppercase"><?php echo e($patient->gender ?? 'N/A'); ?></div>
                            </div>
                        </td>
                        <td>
                            <div class="text-sm">
                                <?php echo e($patient->last_visit ? $patient->last_visit->format('M d, Y') : 'Never'); ?>

                            </div>
                        </td>
                        <td class="text-right">
                            <div class="join">
                                <a href="<?php echo e(route('tenant.patients.show', [$tenant->slug, $patient->id])); ?>" class="btn btn-ghost btn-xs join-item tooltip" data-tip="View Details">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                                    </svg>
                                </a>
                                <a href="<?php echo e(route('tenant.patients.edit', [$tenant->slug, $patient->id])); ?>" class="btn btn-ghost btn-xs join-item tooltip" data-tip="Edit">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <form action="<?php echo e(route('tenant.patients.destroy', [$tenant->slug, $patient->id])); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this patient? This action cannot be undone.')" class="inline">
                                    <?php echo csrf_field(); ?>
...
<dialog id="add_patient_modal" class="modal modal-bottom sm:modal-middle">
    <div class="modal-box max-w-2xl">
        ...
        <form action="<?php echo e(route('tenant.patients.store', $tenant->slug)); ?>" method="POST" class="space-y-4">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.tenant', ['tenant' => $tenant], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/patients/index.blade.php ENDPATH**/ ?>