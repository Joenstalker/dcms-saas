<footer class="footer footer-center p-10 bg-base-200 text-base-content border-t border-base-300">
    <aside class="space-y-4">
        <div class="flex items-center justify-center gap-6 mb-2">
            <img src="<?php echo e(asset('images/BukSU-logo.png')); ?>" alt="BukSU Logo" class="h-16 w-auto drop-shadow-md transition-transform hover:scale-110 duration-300">
            <div class="h-12 w-px bg-base-content/20"></div>
            <img src="<?php echo e(asset('images/COT-logo.png')); ?>" alt="COT Logo" class="h-16 w-auto drop-shadow-md transition-transform hover:scale-110 duration-300">
        </div>
        <div class="space-y-1">
        ...
        <p class="text-xs opacity-50">© <?php echo e(date('Y')); ?> - All rights reserved</p>
    </aside>
    <nav>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/components/footer.blade.php ENDPATH**/ ?>