<?php $__env->startSection('page-title', 'Upgrade Required'); ?>
...
<div class="min-h-[60vh] flex items-center justify-center p-6">
    <div class="max-w-lg w-full bg-base-100 rounded-2xl shadow-xl border border-base-200 overflow-hidden">
        <div class="bg-gradient-to-r from-primary to-secondary p-8 text-center">
            ...
            <p class="text-primary-content/80 mt-2"><?php echo e($feature ?? 'This Feature'); ?></p>
        </div>
        ...
        <div class="p-8 text-center">
            <div class="mb-6">
                ...
                <p class="text-base-content/70"><?php echo e($message ?? 'This feature requires a higher subscription plan.'); ?></p>
            </div>
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('tenant.subscription.select-plan', ['tenant' => $tenant->slug])); ?>" class="flex-1 btn btn-primary">
                    Upgrade Now
                </a>
                <a href="<?php echo e(route('tenant.dashboard', ['tenant' => $tenant->slug])); ?>" class="flex-1 btn btn-ghost">
                    Back to Dashboard
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.tenant', ['tenant' => $tenant], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\subscription-required.blade.php ENDPATH**/ ?>