...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-2">
        <a href="<?php echo e(route('admin.clinics.edit', $tenant)); ?>" class="btn btn-primary">Edit</a>
        <form action="<?php echo e(route('admin.clinics.toggle-active', $tenant)); ?>" method="POST" class="inline">
            <?php echo csrf_field(); ?>
        ...
        <form action="<?php echo e(route('admin.tenants.destroy', $tenant)); ?>" method="POST" data-confirm-delete="Delete Clinic Permanently? This action is irreversible and will erase all data!">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->users->count() > 0): ?>
                    <div class="overflow-x-auto mt-4">
                        <table class="table table-sm">
                            ...
                            <tbody>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $tenant->users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$user->is_system_admin): ?>
                                            <a href="<?php echo e(route('admin.clinics.impersonate', ['clinic' => $tenant->id, 'user' => $user->id])); ?>" target="_blank" class="btn btn-xs btn-ghost gap-1" title="View Portal">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$tenant->isEmailVerified()): ?>
                            <div class="mt-2 space-y-1">
                                <form action="<?php echo e(route('admin.clinics.mark-email-verified', $tenant)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="btn btn-xs btn-success">
                                        Mark as Verified
                                    </button>
                                </form>
                                <form action="<?php echo e(route('admin.clinics.resend-verification', $tenant)); ?>" method="POST" class="inline">
                                    <?php echo csrf_field(); ?>
        ...
        <div class="card bg-base-100 shadow">
            <div class="card-body">
                ...
                <div class="mt-4 space-y-2">
                    <a href="<?php echo e(route('admin.clinics.edit', $tenant)); ?>" class="btn btn-block btn-sm btn-ghost">Edit Clinic</a>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($owner): ?>
                        <a href="<?php echo e(route('admin.clinics.impersonate', ['clinic' => $tenant->id, 'user' => $owner->id])); ?>" target="_blank" class="btn btn-block btn-sm btn-primary">
                            Login as Owner
                        </a>
                    <?php else: ?>
                    ...
                    <a href="<?php echo e(route('admin.role-permission.index', ['tenant_id' => $tenant->id])); ?>" class="btn btn-block btn-sm btn-ghost">Manage Roles & Permissions</a>
                    <button class="btn btn-block btn-sm btn-ghost">Manage Users</button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$tenant->isEmailVerified()): ?>
                        <hr class="my-2">
                        <form action="<?php echo e(route('admin.clinics.mark-email-verified', $tenant)); ?>" method="POST" class="inline w-full">
                            <?php echo csrf_field(); ?>
                            <button type="submit" class="btn btn-block btn-sm btn-success">
                                Mark Email Verified
                            </button>
                        </form>
                        <form action="<?php echo e(route('admin.clinics.resend-verification', $tenant)); ?>" method="POST" class="inline w-full">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\admin\tenants\show.blade.php ENDPATH**/ ?>