            ...
            <div class="flex-1 overflow-y-auto p-6 space-y-4">
                <div class="flex justify-start">
                    <div class="bg-base-200 p-3 rounded-lg rounded-tl-none max-w-[80%]">
                        <p class="text-sm">Hi Dr. <?php echo e(auth()->user()->name); ?>, the patient records for the 2 PM appointment are ready.</p>
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/dentist/tabs/concern.blade.php ENDPATH**/ ?>