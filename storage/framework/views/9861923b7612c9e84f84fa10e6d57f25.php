...
<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
    <?php $__empty_1 = true; $__currentLoopData = $pricingPlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="card bg-base-100 shadow-xl <?php echo e($plan->is_popular ? 'ring-2 ring-primary' : 'border border-base-300'); ?> relative">
        <?php if($plan->is_popular): ?>
            <div class="absolute -top-3 left-1/2 transform -translate-x-1/2">
                <span class="badge <?php echo e($plan->badge_color ?? 'badge-primary'); ?> badge-lg shadow-lg">
        ...
        <div class="card-body">
            ...
            <div class="text-center mb-4">
                <h2 class="card-title text-2xl justify-center"><?php echo e($plan->name); ?></h2>
                <p class="text-sm text-base-content/60 mt-1"><?php echo e($plan->slug); ?></p>
            </div>

            <!-- Price -->
            <div class="text-center mb-4">
                <div class="text-4xl font-bold"><?php echo e($plan->getFormattedPrice()); ?></div>
                <?php if($plan->price > 0): ?>
