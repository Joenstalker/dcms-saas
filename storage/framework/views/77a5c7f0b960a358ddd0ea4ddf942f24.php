...
<div class="p-6">
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->pricingPlan?->slug !== 'pro' && $tenant->pricingPlan?->slug !== 'ultimate'): ?>
            ...
            <div class="card bg-primary text-primary-content shadow-xl">
                <div class="card-body items-center text-center">
                    ...
                    <div class="card-actions mt-6">
                        <a href="<?php echo e(route('tenant.subscription.select-plan', ['tenant' => $tenant->slug])); ?>" class="btn btn-secondary">View Pricing Plans</a>
                    </div>
                </div>
            </div>
        <?php else: ?>
...
<?php echo $__env->make('layouts.tenant', ['tenant' => $tenant], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\RolePermission.blade.php ENDPATH**/ ?>