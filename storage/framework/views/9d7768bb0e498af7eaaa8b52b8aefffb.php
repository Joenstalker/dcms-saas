            ...
            <div class="card-body">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center pb-4 border-b">
                        <div>
                            <h3 class="font-bold text-lg"><?php echo e($plan->name); ?> Plan</h3>
                            <p class="text-sm text-base-content/70"><?php echo e($plan->description); ?></p>
                        </div>
                        <div class="text-right">
                            <div class="text-2xl font-bold text-primary">₱<?php echo e(number_format($plan->price, 0)); ?></div>
                        ...
                        <ul class="space-y-2">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->max_users): ?>
                                <li class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm">Up to <?php echo e($plan->max_users); ?> users</span>
                                </li>
                            <?php else: ?>
                                <li class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($plan->max_patients): ?>
                                <li class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm">Up to <?php echo e(number_format($plan->max_patients)); ?> patients</span>
                                </li>
                            <?php else: ?>
                                <li class="flex items-center gap-2">
                                    <svg class="w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <div class="flex justify-between items-center text-lg font-bold">
                        ...
                        <span class="text-primary text-2xl">₱<?php echo e(number_format($plan->price, 0)); ?></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <form id="payment-form">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 mt-6">
                        <a href="<?php echo e(route('tenant.subscription.cancel', $tenant)); ?>" class="btn btn-outline flex-1">
                            Cancel
                        </a>
                        <button type="submit" id="submit" class="btn btn-primary btn-lg flex-1">
                            <span id="button-text">Pay ₱<?php echo e(number_format($plan->price, 0)); ?></span>
    ...
    form.addEventListener('submit', async (event) => {
        ...
        const { error } = await stripe.confirmPayment({
            ...
            confirmParams: {
                ...
                return_url: "<?php echo e(route('tenant.subscription.confirm-payment', ['tenant' => $tenant, 'plan' => $plan->id])); ?>",
            },
        });
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\tenant\subscription\payment.blade.php ENDPATH**/ ?>