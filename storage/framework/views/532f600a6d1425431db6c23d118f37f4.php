...
<div class="p-6">
    ...
    <div class="alert alert-warning mb-6 shadow-lg">
        ...
        <div>
            <a href="<?php echo e(route('tenant.subscription.select-plan', $tenant)); ?>" class="btn btn-sm btn-warning">
                Select Plan
            </a>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-r from-primary to-secondary rounded-lg p-6 mb-6 text-white">
        ...
        <p class="text-white/80"><?php echo e($tenant->name); ?></p>
    </div>
            ...
            <div class="card bg-base-100 shadow-lg">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        ...
                        <a href="<?php echo e(route('tenant.masterfile.index', $tenant)); ?>" class="btn btn-outline btn-lg flex-col h-auto py-4">
                            <svg class="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span>Masterfile</span>
                        </a>
                        <a href="<?php echo e(route('tenant.expenses.index', $tenant)); ?>" class="btn btn-outline btn-lg flex-col h-auto py-4">
                            <svg class="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
