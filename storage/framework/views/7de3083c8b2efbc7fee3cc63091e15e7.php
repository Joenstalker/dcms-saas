...
<div style="text-align: center; margin-bottom: 20px;">
    <img src="<?php echo new \Illuminate\Support\EncodedHtmlString($message->embed(public_path('images/dcms-logo.png'))); ?>" alt="DCMS Logo" style="max-height: 80px;">
</div>

# Welcome to DCMS – Your Clinic Portal

Hello <?php echo new \Illuminate\Support\EncodedHtmlString($tenantName); ?>,
...
Or copy and paste this link: <?php echo new \Illuminate\Support\EncodedHtmlString($loginUrl); ?>
...
Thank you,
<?php echo new \Illuminate\Support\EncodedHtmlString(config('app.name')); ?> Provider Team
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
