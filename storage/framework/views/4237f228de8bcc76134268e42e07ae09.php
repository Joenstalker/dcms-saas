...
<dialog id="service-modal" class="modal">
    <div class="modal-box max-w-2xl">
        ...
        <form id="service-form" method="POST" action="<?php echo e(route('tenant.services.store.service', request()->route('tenant'))); ?>">
            <?php echo csrf_field(); ?>
...
function editService(service) {
    ...
    document.getElementById('service-form').action = '<?php echo e(route("tenant.services.update.service", ["tenant" => request()->route("tenant"), "service" => "__ID__"])); ?>'.replace('__ID__', service.id || service._id);
...
function resetServiceForm() {
    ...
    document.getElementById('service-form').action = '<?php echo e(route("tenant.services.store.service", request()->route("tenant"))); ?>';
    document.getElementById('service-method').value = 'POST';
    document.getElementById('service-form').reset();
}
</script>
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/services/partials/modal-service.blade.php ENDPATH**/ ?>