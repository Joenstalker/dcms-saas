...
<dialog id="certificate-modal" class="modal">
    <div class="modal-box max-w-3xl">
        ...
        <form id="certificate-form" method="POST" action="<?php echo e(route('tenant.services.store.certificate', request()->route('tenant'))); ?>">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.wysiwyg-editor','data' => ['name' => 'template_html','label' => 'Certificate Template','variables' => ['[[PatientName]]', '[[Date]]', '[[DoctorName]]', '[[ClinicName]]', '[[Procedure]]', '[[Findings]]', '[[Age]]', '[[Sex]]']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'template_html','label' => 'Certificate Template','variables' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['[[PatientName]]', '[[Date]]', '[[DoctorName]]', '[[ClinicName]]', '[[Procedure]]', '[[Findings]]', '[[Age]]', '[[Sex]]'])]); ?>
...
function editCertificateTemplate(template) {
    ...
    document.getElementById('certificate-form').action = '<?php echo e(route("tenant.services.update.certificate", ["tenant" => request()->route("tenant"), "template" => "__ID__"])); ?>'.replace('__ID__', template.id || template._id);
...
function resetCertificateForm() {
    ...
    document.getElementById('certificate-form').action = '<?php echo e(route("tenant.services.store.certificate", request()->route("tenant"))); ?>';
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/services/partials/modal-certificate.blade.php ENDPATH**/ ?>