...
<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-2">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->is_active): ?>
            <form action="<?php echo e(route('admin.tenants.suspend', $tenant)); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-warning">Deactivate</button>
            </form>
        <?php else: ?>
            <form action="<?php echo e(route('admin.tenants.reactivate', $tenant)); ?>" method="POST" class="inline">
                <?php echo csrf_field(); ?>
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$user->is_system_admin): ?>
                                            <a href="<?php echo e(route('admin.tenants.impersonate', ['tenant' => $tenant->id, 'user' => $user->id])); ?>" target="_blank" class="btn btn-xs btn-ghost gap-1" title="View Portal">
                ...
                <div class="mt-4 space-y-3">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->pricingPlan): ?>
                            ...
                            <p class="text-sm text-base-content/70">₱<?php echo e(number_format((float) (string) $tenant->pricingPlan->price, 2)); ?>/<?php echo e($tenant->pricingPlan->billing_cycle); ?></p>
                        <?php else: ?>
        ...
        <div class="card bg-base-100 shadow">
            <div class="card-body">
                ...
                <div class="mt-4 space-y-2">
                    <a href="<?php echo e(route('admin.tenants.edit', $tenant)); ?>" class="btn btn-block btn-sm btn-ghost">Edit Clinic</a>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($owner): ?>
                        <a href="<?php echo e(route('admin.tenants.impersonate', ['tenant' => $tenant->id, 'user' => $owner->id])); ?>" target="_blank" class="btn btn-block btn-sm btn-primary">
                            Login as Owner
                        </a>
                    <?php else: ?>
