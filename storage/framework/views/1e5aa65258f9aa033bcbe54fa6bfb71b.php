        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo e(Str::limit($template->content, 50) ?: '-'); ?></td>
                    ...
                    <td>
                        <div class="flex gap-1">
                            <button onclick="editConsentTemplate(<?php echo e(json_encode($template)); ?>)" class="btn btn-ghost btn-xs">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                            </button>
                            <form method="POST" action="<?php echo e(route('tenant.services.destroy.consent', ['tenant' => request()->route('tenant'), 'template' => $template->id])); ?>" data-confirm-delete="Delete this consent template?">
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/services/partials/consent-table.blade.php ENDPATH**/ ?>