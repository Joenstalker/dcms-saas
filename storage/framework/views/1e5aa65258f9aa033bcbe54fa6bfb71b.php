                ...
                <tr>
                    ...
                    <td>
                        <div class="flex gap-1">
                            ...
                            <form method="POST" action="<?php echo e(route('tenant.services.destroy.consent', ['tenant' => request()->route('tenant'), 'template' => $template->id])); ?>" onsubmit="return confirm('Delete this template?')">
