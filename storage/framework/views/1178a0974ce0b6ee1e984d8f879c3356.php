        ...
        <div class="card bg-base-100 shadow-2xl">
            <div class="card-body text-center p-8 sm:p-12">
                ...
                <p class="text-lg text-base-content/70 mb-6">
                    Your subscription for <strong><?php echo e($tenant->name); ?></strong> has been activated.
                </p>
                ...
                <div class="bg-base-200 rounded-lg p-6 mb-6 text-left">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold"><?php echo e($tenant->pricingPlan->name); ?></span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-base-content/70">Monthly Fee:</span>
                            <span class="font-semibold">₱<?php echo e(number_format($tenant->pricingPlan->price, 0)); ?></span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->subscription_ends_at): ?>
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold"><?php echo e($tenant->subscription_ends_at->format('F d, Y')); ?></span>
                            </div>
                    ...
                    <div class="text-left bg-base-200 rounded-lg p-4">
                        ...
                        <ul class="space-y-2 text-sm">
                            <li class="flex items-center gap-2">
                                ...
                                Access your clinic dashboard at: <strong><?php echo e($tenant->slug); ?>.dcmsapp.com</strong>
                            </li>
                            <li class="flex items-center gap-2">
                                <svg class="w-4 h-4 text-success" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd" />
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center mt-6">
                    <a href="<?php echo e(route('tenant.dashboard', $tenant)); ?>" class="btn btn-primary btn-lg">
                        Go to Dashboard
                    </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/subscription/success.blade.php ENDPATH**/ ?>