                            ...
                            <div class="flex items-center justify-end relative z-10">
                                <div class="dropdown dropdown-end">
                                    ...
                                    <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-lg shadow-2xl w-52 p-2 border border-base-300 z-[100] mt-1">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->subscription_status !== 'suspended' && $tenant->subscription_status !== 'terminated'): ?>
                                        <li>
                                            <button onclick="lifecycleAction('<?php echo e(route('admin.tenants.suspend', $tenant)); ?>', 'Suspend', '<?php echo e($tenant->name); ?>', 'warning')" class="flex items-center gap-2 text-warning">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->subscription_status === 'suspended' || $tenant->subscription_status === 'terminated'): ?>
                                        <li>
                                            <button onclick="lifecycleAction('<?php echo e(route('admin.tenants.reactivate', $tenant)); ?>', 'Reactivate', '<?php echo e($tenant->name); ?>', 'success')" class="flex items-center gap-2 text-success">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->subscription_status !== 'terminated'): ?>
                                        <li>
                                            <button onclick="lifecycleAction('<?php echo e(route('admin.tenants.terminate', $tenant)); ?>', 'Terminate', '<?php echo e($tenant->name); ?>', 'error')" class="flex items-center gap-2 text-error">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->subscription_status === 'terminated'): ?>
                                        <li>
                                            <button onclick="permanentDelete('<?php echo e(route('admin.tenants.destroy', $tenant)); ?>', '<?php echo e($tenant->name); ?>')" class="w-full text-left text-error flex items-center gap-2">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dentistmng\dcms-saas\resources\views\admin\tenants\index.blade.php ENDPATH**/ ?>