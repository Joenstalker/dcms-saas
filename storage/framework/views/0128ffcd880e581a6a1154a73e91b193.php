    ...
    <div class="flex items-center gap-3">
        ...
        <div class="dropdown dropdown-end">
            ...
            <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-50 p-2 shadow-xl bg-base-100 rounded-box w-56 border border-base-300">        
                ...
                <li><hr class="my-2"></li>
                <li>
                    <form id="admin-logout-form" action="<?php echo e(route('admin.logout')); ?>" method="POST" class="hidden">
                        <?php echo csrf_field(); ?>
                    </form>
    ...
    (function () {
        ...
        saveButton.addEventListener('click', async () => {
            ...
            try {
                ...
                const response = await fetch("<?php echo e(route('admin.profile.photo.update')); ?>", {
                    method: 'POST',
                    body: formData,
                    headers: {
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views\admin\components\navbar.blade.php ENDPATH**/ ?>