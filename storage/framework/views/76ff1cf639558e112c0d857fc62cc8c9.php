...
<dialog id="prescription-modal" class="modal">
    <div class="modal-box max-w-3xl">
        ...
        <form id="prescription-form" method="POST" action="<?php echo e(route('tenant.services.store.prescription', request()->route('tenant'))); ?>">
            <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.wysiwyg-editor','data' => ['name' => 'instructions','label' => 'Instructions / Content','variables' => ['[[PatientName]]', '[[Date]]', '[[DoctorName]]', '[[ClinicName]]', '[[Medications]]']]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'instructions','label' => 'Instructions / Content','variables' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(['[[PatientName]]', '[[Date]]', '[[DoctorName]]', '[[ClinicName]]', '[[Medications]]'])]); ?>
...
function editPrescriptionTemplate(template) {
    ...
    document.getElementById('prescription-form').action = '<?php echo e(route("tenant.services.update.prescription", ["tenant" => request()->route("tenant"), "template" => "__ID__"])); ?>'.replace('__ID__', template.id || template._id);
...
function resetPrescriptionForm() {
    ...
    document.getElementById('prescription-form').action = '<?php echo e(route("tenant.services.store.prescription", request()->route("tenant"))); ?>';
...
<?php /**PATH D:\dentistmng\dcms-saas\resources\views/tenant/services/partials/modal-prescription.blade.php ENDPATH**/ ?>