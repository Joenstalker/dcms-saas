                            ...
                            <tr>
                                <td colspan="6" class="text-center py-12">
                                    <div class="flex flex-col items-center gap-3">
                                        ...
                                        <a href="{{ route('admin.tenants.create') }}" class="btn btn-sm btn-primary">Create First Tenant</a>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
        ...
        <div class="space-y-6">
            ...
            <div class="card bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20 shadow-lg">
                <div class="card-body">
                    ...
                    <div class="space-y-2">
                        <a href="{{ route('admin.tenants.create') }}" class="btn btn-primary btn-block justify-start gap-2">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
