    ...
    <div class="dropdown-content z-50 mt-2">
        ...
        @if($customThemes->count() > 0)
            ...
            @foreach($customThemes as $ct)
                <li>
                    <button type="button" class="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-base-200 transition-colors group" data-set-theme="custom-{{ $ct->slug }}">
        ...
        @foreach($standardThemes as $value => $label)
            <li>
                <button type="button" class="flex items-center justify-between px-3 py-2 rounded-lg hover:bg-base-200 transition-colors group" data-set-theme="{{ $value }}">
