                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="text-sm text-base-content/70 md:hidden">{{ $tenant->email }}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                            ...
                            <div class="flex items-center justify-end gap-2">
                                <div class="dropdown dropdown-end">
                                    ...
                                    <ul tabindex="0" class="dropdown-content menu bg-base-100 rounded-box shadow-lg w-40 p-2 border border-base-300 z-[1]">
                                        <li><a href="{{ route('admin.tenants.show', $tenant) }}">View Details</a></li>
                                        <li><a href="{{ route('admin.tenants.edit', $tenant) }}">Edit</a></li>
                                        <li><hr class="my-1"></li>
                                        <li>
                                            <form action="{{ route('admin.tenants.toggle-active', $tenant) }}" method="POST" class="inline">
                                                @csrf
                                                <button type="submit" class="w-full text-left {{ $tenant->is_active ? 'text-warning' : 'text-success' }}">
                                        ...
                                        <li><hr class="my-1"></li>
                                        <li>
                                            <button onclick="deleteModal{{ $tenant->id }}.showModal()" class="w-full text-left text-error">
                                                Delete Permanently
                                            </button>
                                        </li>
                                    </ul>
