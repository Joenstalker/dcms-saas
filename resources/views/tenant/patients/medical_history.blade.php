<div class="flex items-center justify-between mb-6">
    ...
    <div class="flex gap-2">
        <span class="badge badge-outline badge-sm text-xs opacity-70">Source: {{ $source ?? 'Face-to-Face' }}</span>
        <span class="text-xs opacity-50">{{ $entry_date ?? now()->format('M d, Y') }}</span>
    </div>
</div>
