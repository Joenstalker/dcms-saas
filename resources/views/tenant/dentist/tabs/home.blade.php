    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="stats shadow bg-base-100 border-l-4 border-primary">
            <div class="stat">
                ...
                <div class="stat-value text-primary text-2xl">{{ $stats['today_appointments'] }}</div>
        ...
        <div class="stats shadow bg-base-100 border-l-4 border-secondary">
            <div class="stat">
                ...
                <div class="stat-value text-secondary text-2xl">{{ $stats['total_patients'] }}</div>
        ...
        <div class="stats shadow bg-base-100 border-l-4 border-success">
            <div class="stat">
                ...
                <div class="stat-value text-success text-2xl">₱{{ number_format($stats['income_today'], 2) }}</div>
                        ...
                        <table class="table table-zebra w-full">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="badge badge-sm badge-outline">{{ $appointment->status }}</span></td>
                                    <td class="text-right">
                    ...
                    <div class="divide-y divide-base-200">
                        ...
                        <div class="p-4 flex items-center gap-3 hover:bg-base-200/50 cursor-pointer transition-colors">
                            ...
                            <div class="flex-1 overflow-hidden">
                                <div class="font-bold text-sm truncate">{{ $patient->first_name }} {{ $patient->last_name }}</div>
                                <div class="text-[10px] opacity-60">{{ $patient->phone }}</div>
                            </div>
