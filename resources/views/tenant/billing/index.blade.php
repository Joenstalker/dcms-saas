...
@section('page-title', 'Billing & POS')
...
<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex gap-2">
            <a href="{{ route('tenant.billing.create', $tenant->slug) }}" class="btn btn-primary">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div class="stat bg-base-100 border border-base-300 rounded-xl shadow-sm">
            ...
            <div class="stat-value text-primary text-2xl">Php {{ number_format($invoices->sum('grand_total'), 2) }}</div>
        ...
        <div class="stat bg-base-100 border border-base-300 rounded-xl shadow-sm">
            ...
            <div class="stat-value text-error text-2xl">Php {{ number_format($invoices->where('status', 'Unpaid')->sum('grand_total'), 2) }}</div>
        ...
        <div class="stat bg-base-100 border border-base-300 rounded-xl shadow-sm">
            ...
            <div class="stat-value text-2xl">{{ $invoices->total() }}</div>
        ...
        <div class="overflow-x-auto">
            <table class="table table-zebra w-full">
                ...
                <tbody>
                    ...
                    <tr onclick="window.location='{{ route('tenant.billing.show', [$tenant->slug, $invoice->id]) }}'" class="hover:bg-primary/5 cursor-pointer transition-colors group border-b border-base-200 last:border-0">
                        <td class="pl-6 py-4">
                    ...
                    <tr>
                        <td colspan="5" class="text-center py-20 bg-base-100/50">
                            <div class="flex flex-col items-center text-base-content/40">
                                ...
                                <a href="{{ route('tenant.billing.create', $tenant->slug) }}" class="btn btn-primary btn-sm mt-6 rounded-xl shadow-lg shadow-primary/20">New Transaction</a>
                            </div>
                        </td>
                    </tr>
                    @endforelse
