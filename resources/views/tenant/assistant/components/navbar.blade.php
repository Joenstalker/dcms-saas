<div id="assistant-navbar" data-turbo-permanent class="navbar bg-base-100 border-b border-base-300 px-6 sticky top-0 z-30">
    ...
    <div class="flex-1">
        <h2 class="text-xl font-semibold">@yield('page-title', 'Assistant Portal')</h2>
    </div>
