            ...
            <div class="card-body">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-secondary">{{ $stats['total_appointments'] }}</p>
                    </div>
            ...
            <div class="card-body">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-accent">{{ $stats['today_appointments'] }}</p>
                    </div>
            ...
            <div class="card bg-base-100 shadow-lg">
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
                        @if(empty($modules) || in_array('patients', $modules))
                        <a href="{{ route('tenant.patients.index', $tenant) }}" class="btn btn-outline btn-lg flex-col h-auto py-4">
                        ...
                        @endif
                        @if(empty($modules) || in_array('appointments', $modules))
                        <a href="{{ route('tenant.appointments.index', $tenant) }}" class="btn btn-outline btn-lg flex-col h-auto py-4">
                            <svg class="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                        ...
                        @endif
                        @if(empty($modules) || in_array('services', $modules))
                        <a href="{{ route('tenant.services.index', $tenant) }}" class="btn btn-outline btn-lg flex-col h-auto py-4">
                            <svg class="w-6 h-6 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
